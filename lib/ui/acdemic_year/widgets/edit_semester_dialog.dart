...
class EditSemesterDialog extends StatefulWidget {
  ...
  const EditSemesterDialog({Key key, this.semester, this.value})
      : super(key: key);

  @override
  _EditSemesterDialogState createState() => _EditSemesterDialogState();
}
...
class _EditSemesterDialogState extends State<EditSemesterDialog>
  ...
  Widget build(BuildContext context) {
    checkyear = widget.semester.isCurrentYear;
    checksemesteris = widget.semester.isCurrentSemester;
                ...
                child: Column(
                  children: [
                    TextFormField(
                      ...
                      initialValue:
                          widget.value == 0 ? "${widget.semester.name}" : null,
                    ),
                    SizedBox(
                      height: 10,
                    ),
