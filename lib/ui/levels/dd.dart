...
class _LevelsScreenState extends State<LevelsScreen> with ValidationMixin {
                      ...
                      child: TextField(
                        ...
                        onChanged: (text) {
                          ...
                          if (text.isEmpty) {
                            ...
                            _LevelsList.forEach((userDetail) {
                              if (userDetail.name
                                  .toLowerCase()
                    ...
                    Expanded(
                      child: BlocBuilder<LevelsBloc, LevelsState>(
                        ...
                        if (state is LevelLoading) {
                          ...
                          _LevelsList = state.levels;
                          return _buildListLevels(_LevelsList);
  ...
  Widget _buildListLevels(_LevelsList) {
    return _LevelsList.length > 0
        ? _searchResult.length != 0 || _searchController.text.isNotEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return LevelsItem(
                    levels: _LevelsList[index],
                  );
                })
        : NoData(message: 'No Level');
  }
