...
class CustomTextFormField extends StatefulWidget {
  ...
  CustomTextFormField(
      ...
      this.prefixIcon,
      this.labelText,
      this.controller,  this.suffixIconImagePath,
      this.prefixIconImagePath, this.prefix});
      ...
      decoration: InputDecoration(
        ...
        fillColor: Colors.white,
          ...
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(widget.borderRadius != null ? widget.borderRadius : 10.0),
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      return Container(
          ...
          margin: EdgeInsets.symmetric(horizontal: widget.enableHorizontal ?
